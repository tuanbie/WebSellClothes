...
<body>
    ...
    <section class="category">
        ...
        <!-- tab hiển thị gồm loại và mẫu mã -->
        <div class="container">
            <div class="row">
                ...
                <!-- các thẻ sản phẩm gồm hình, tên, giá -->
    ...
    <script src="/MyWeb/js/categoryJS.js"></script>
</body>
